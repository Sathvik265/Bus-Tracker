        ...
        <div className="flex items-center space-x-4 cursor-pointer" onClick={() => onNavigate('HOME')}>
          <div className="bg-white p-1 rounded-md shadow-inner">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-brand-dark" viewBox="0 0 24 24" fill="currentColor">
              <path d="M19.5 6.5C19.5 5.39543 18.6046 4.5 17.5 4.5H6.5C5.39543 4.5 4.5 5.39543 4.5 6.5V17.5C4.5 18.6046 5.39543 19.5 6.5 19.5H17.5C18.6046 19.5 19.5 18.6046 19.5 17.5V6.5ZM3 6.5C3 4.567 4.567 3 6.5 3H17.5C19.433 3 21 4.567 21 6.5V17.5C21 19.433 19.433 21 17.5 21H6.5C4.567 21 3 19.433 3 17.5V6.5Z" />
