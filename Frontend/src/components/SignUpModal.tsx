        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand focus:border-brand outline-none transition-all text-slate-900 placeholder-gray-400 bg-white text-black"
