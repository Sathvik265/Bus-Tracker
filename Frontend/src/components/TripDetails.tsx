...
const TripDetails: React.FC<{ trip: Trip, onConfirmBooking: (seats: Seat[]) => void }> = ({ trip, onConfirmBooking }) => {
    const [activeTab, setActiveTab] = useState<'ROUTE' | 'BOOKING'>('BOOKING');

    return (
        <div className="bg-gray-50 rounded-b-xl border-x-2 border-b-2 border-brand animate-fade-in -mt-2">
            ...
            <div className="p-5">
                        ...
                        <div className="relative pl-3">
                            ...
                            <div className="relative flex items-center mb-4">
                                <div className="z-10 bg-gray-50">
                                    <div className="h-7 w-7 rounded-full bg-brand ring-4 ring-gray-50 flex items-center justify-center text-white font-bold"></div>
                                </div>
                            ...
                            {trip.route.stops.map((stop, index) => (
                                <div key={index} className="relative flex items-center mb-4">
                                    <div className="z-10 bg-gray-50">
                                        <div className="h-4 w-4 rounded-full bg-slate-400 ring-4 ring-gray-50 ml-[6px]"></div>
                                    </div>
                            ...
                            {/* Destination */}
                             <div className="relative flex items-center">
                                <div className="z-10 bg-gray-50">
                                    <div className="h-7 w-7 rounded-full bg-brand ring-4 ring-gray-50 flex items-center justify-center text-white">
                ...
                {activeTab === 'BOOKING' && (
                    <BookingPage trip={trip} onConfirmBooking={onConfirmBooking} />
                )}
            </div>
        </div>
    );
